...
local function buildOptions()
	if not loaded then
		...
		addCheckButton( "guiShowNormalTBCDaily", SHOW.." "..LFG_TYPE_DUNGEON.." "..DAILY, "", Reputable_Data.global, "guiShowNormalTBCDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowHeroicTBCDaily", SHOW.." "..LFG_TYPE_HEROIC_DUNGEON.." "..DAILY, "", Reputable_Data.global, "guiShowHeroicTBCDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowCookingTBCDaily", SHOW.." "..PROFESSIONS_COOKING.." "..DAILY, "", Reputable_Data.global, "guiShowCookingTBCDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowFishingTBCDaily", SHOW.." "..PROFESSIONS_FISHING.." "..DAILY, "", Reputable_Data.global, "guiShowFishingTBCDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowPvPTBCDaily", SHOW.." "..PVP.." "..DAILY, "", Reputable_Data.global, "guiShowPvPTBCDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowNormalWOTLKDaily", SHOW.." "..LFG_TYPE_DUNGEON.." "..DAILY, "", Reputable_Data.global, "guiShowNormalWOTLKDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowHeroicWOTLKDaily", SHOW.." "..LFG_TYPE_HEROIC_DUNGEON.." "..DAILY, "", Reputable_Data.global, "guiShowHeroicWOTLKDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowCookingWOTLKDaily", SHOW.." "..PROFESSIONS_COOKING.." "..DAILY, "", Reputable_Data.global, "guiShowCookingWOTLKDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowFishingWOTLKDaily", SHOW.." "..PROFESSIONS_FISHING.." "..DAILY, "", Reputable_Data.global, "guiShowFishingWOTLKDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowPvPWOTLKDaily", SHOW.." "..PVP.." "..DAILY, "", Reputable_Data.global, "guiShowPvPWOTLKDaily", function() config:guiUpdate(true) end )
